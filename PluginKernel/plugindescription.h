...
#define AU_COCOA_VIEWFACTORY_NAME AUCocoaViewFactory_5CC736E5E38A41E5B50A0DF48A1013E1
#define AU_COCOA_VIEW_NAME AUCocoaView_5CC736E5E38A41E5B50A0DF48A1013E1
...
const char* kAAXBundleID = "rackafxuser.aax.SimpleSynth.bundleID";
const char* kVST3BundleID = "rackafxuser.vst3.SimpleSynth.bundleID";

// --- For AU: make sure BOTH the Plugin Target and the CocoaUI Target PRODUCT_BUNDLE_IDENTIFIER settings match these strings
const char* kAUBundleID = "rackafxuser.au.SimpleSynth.bundleID";

// --- plugin NAME
/* AU only: this MUST EXACLTY match the Product Name in Build Settings for BOTH the CocoaUI and your Plugin Targets! */
const char* kPluginName = "SimpleSynth";     // 31 chars max for AAX
const char* kShortPluginName = "SimpleSynth";    // 15 chars max for AAX
const char* kAUBundleName = "SimpleSynth";
...
// --- VST3 & AAX only
const int32_t kFourCharCode = 'erqe'; /// must be unique for each plugin in your company
...
const char* kVSTFUID = "{5CC736E5-E38A-41E5-B50A-0DF48A1013E1}"; /// NOTE: you need the enclosing { }

// --- AAX specific
const int32_t kManufacturerID = 'VNDR';
const int32_t kAAXProductID = 'adfa';
